    ...
    <div class="container_12">
        ...
        <div class="grid_12">
            <ul class="nav main">
                ...
                <li class="ic-form-style"><a href="thems.php"><span>Thems</span></a></li>
                ...
                <?php if (Session::get('userrole')=='0') { ?>
                 <li class="ic-charts"><a href="adduser.php"><span>Add New User</span></a></li>   <?php } ?>
